package com.sha.food_delivery_app.customview
...
open class ShaFloatingActionButton @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = R.attr.floatingActionButtonStyle
) : FloatingActionButton(context, attrs, defStyleAttr) {

    private val STATE_KEY = ShaFloatingActionButton::class.java.name + ".STATE"
    private val COUNT_STATE = "COUNT"

    private val NORMAL_MAX_COUNT = 99
    private val NORMAL_MAX_COUNT_TEXT = "99+"

    private val MINI_MAX_COUNT = 9
    private val MINI_MAX_COUNT_TEXT = "9+"
    ...
    private val RIGHT_TOP_POSITION = 0
    private val LEFT_BOTTOM_POSITION = 1
    private val LEFT_TOP_POSITION = 2
    private val RIGHT_BOTTOM_POSITION = 3

    private val animationProperty = object : Property<ShaFloatingActionButton, Float>(Float::class.java, "animation") {

        override fun set(counterFab: ShaFloatingActionButton, value: Float) {
            animationFactor = value
            postInvalidateOnAnimation()
        }

        override fun get(counterFab: ShaFloatingActionButton): Float {
            return 0f
        }
    }
    ...
    private val textPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        ...
        textSize = this@ShaFloatingActionButton.textSize
    ...
    init {
        val styledAttributes = context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.ShaFloatingActionButton, 0, 0
        )
        textPaint.color = styledAttributes.getColor(R.styleable.ShaFloatingActionButton_badgeTextColor, Color.WHITE)
        circlePaint.color = styledAttributes.getColor(R.styleable.ShaFloatingActionButton_badgeBackgroundColor, getDefaultBadgeColor())
        badgePosition = styledAttributes.getInt(R.styleable.ShaFloatingActionButton_badgePosition, RIGHT_TOP_POSITION)
